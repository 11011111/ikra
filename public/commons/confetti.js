...
!function (t, e) {
  ...
  const i = "generated", s = "pointerdown", o = "pointerup", n = "pointerleave", a = "pointerout", r = "pointermove",
    c = "touchstart", l = "touchend", h = "touchmove", d = "touchcancel", u = "resize", p = "visibilitychange",
    f = "tsParticles - Error";
  ...
  function D(t, e) {
    ...
    const i = S(t), s = k(t);
    return void 0 !== e ? {min: Math.min(i, e), max: Math.max(s, e)} : D(i, s)
  }
  ...
  function L(t) {
    return {x: (t.position?.x ?? 100 * _()) * t.size.width / 100, y: (t.position?.y ?? 100 * _()) * t.size.height / 100}
  }
  ...
  function B(t) {
    return {x: t.position?.x ?? _() * t.size.width, y: t.position?.y ?? _() * t.size.height}
  }
  ...
  function H(t) {
    const e = {bounced: !1}, {pSide: i, pOtherSide: s, rectSide: o, rectOtherSide: n, velocity: a, factor: r} = t;
  ...
  function lt(t, e) {
    const {x: i, y: s} = t.velocity.sub(e.velocity), [o, n] = [t.position, e.position], {dx: a, dy: r} = O(n, o);
    if (i * a + s * r < 0) return;
    const c = -Math.atan2(r, a), l = t.mass, h = e.mass, d = t.velocity.rotate(c), u = e.velocity.rotate(c),
      p = R(d, u, l, h), f = R(u, d, l, h), m = p.rotate(-c), v = f.rotate(-c);
  ...
  function mt(t, e) {
    ...
    return "x" in t ? {x: t.x / 100 * e.width, y: t.y / 100 * e.height} : {
  ...
  function Et(t) {
    const e = t.r / 255, i = t.g / 255, s = t.b / 255, o = Math.max(e, i, s), n = Math.min(e, i, s),
      a = {h: 0, l: .5 * (o + n), s: 0};
  ...
  function Lt(t) {
    const e = (t.h % 360 + 360) % 360, i = Math.max(0, Math.min(100, t.s)), s = e / 360, o = i / 100,
    ...
    const a = (t, e, i) => (i < 0 && (i += 1), i > 1 && (i -= 1), 6 * i < 1 ? t + 6 * (e - t) * i : 2 * i < 1 ? e : 3 * i < 2 ? t + (e - t) * (2 / 3 - i) * 6 : t),
      r = n < .5 ? n * (1 + o) : n + o - n * o, c = 2 * n - r, l = Math.min(255, 255 * a(c, r, s + 1 / 3)),
      h = Math.min(255, 255 * a(c, r, s)), d = Math.min(255, 255 * a(c, r, s - 1 / 3));
  ...
  function Bt(t) {
    const e = t ?? 0;
    return {b: Math.floor(C(D(e, 256))), g: Math.floor(C(D(e, 256))), r: Math.floor(C(D(e, 256)))}
  }
  ...
  function Gt(t, e, i) {
    ...
    return s === Mt ? i ? Dt({value: s}) : e ? Mt : Ct : s === Ct ? Ct : Dt({value: s})
  }
  ...
  function Qt(t) {
    const {
        ...
        shadow: h,
        transform: d
      } = t, u = s.getPosition(), p = s.rotation + (s.pathRotation ? s.velocity.angle : 0), f = Math.sin(p),
      m = Math.cos(p), v = {a: m * (d.a ?? 1), b: f * (d.b ?? 1), c: -f * (d.c ?? 1), d: m * (d.d ?? 1)};
    ...
    const w = {container: e, context: i, particle: s, radius: c, opacity: l, delta: o, transformData: v};
  ...
  class ne {
    constructor(t) {
      this.container = t, this._applyPostDrawUpdaters = t => {
        ...
        t && (this._safeMutationObserver((t => t.disconnect())), this._initStyle(), this.initBackground(), this._safeMutationObserver((e => e.observe(t, {attributes: !0}))))
    ...
    drawParticle(t, e) {
      ...
      n || (n = s), a || (a = o), (n || a) && this.draw((s => {
        const o = this.container, r = o.actualOptions, c = t.options.zIndex, l = (1 - t.zIndexFactor) ** c.opacityRate,
          h = t.bubble.opacity ?? t.opacity?.value ?? 1, d = h * l, u = (t.strokeOpacity ?? h) * l, p = {},
    ...
    resize() {
      ...
      const t = this.container, e = t.retina.pixelRatio, i = t.canvas.size, s = this.element.offsetWidth * e,
    ...
    constructor(t) {
      this.container = t, this._doMouseTouchClick = t => {
        ...
        if (this._canPush) {
          ...
          if (!s) return;
          t.clickPosition = {...s}, t.clickTime = (new Date).getTime();
        ...
        const e = t, i = this.container, s = i.options, o = s.defaultThemes, n = e.matches ? o.dark : o.light,
        ...
        if (s.mouse.inside = !0, t.type.startsWith("pointer")) {
          ...
          if (s.element === window) {
            ...
            if (t && i && o) {
              ...
              n = {x: e.offsetX + 2 * s.left - (a.left + r.left), y: e.offsetY + 2 * s.top - (a.top + r.top)}
            } else n = {x: e.offsetX ?? e.clientX, y: e.offsetY ?? e.clientY}
          } else e.target === o && (n = {x: e.offsetX ?? e.clientX, y: e.offsetY ?? e.clientY})
  ...
  class ce {
    ...
    static create(t, e) {
      const i = new ce;
      return i.load(t), void 0 !== e && (wt(e) || zt(e) ? i.load({value: e}) : i.load(e)), i
    }
    ...
    load(t) {
      if (t) {
        if (void 0 !== t.composite && (this.composite = t.composite), void 0 !== t.cover) {
          const e = t.cover, i = wt(t.cover) ? {color: t.cover} : t.cover;
  ...
  class Xe {
    ...
    load(t) {
      if (!t) return;
      this.angle.load(bt(t.angle) ? {value: t.angle} : t.angle), this.attract.load(t.attract), this.center.load(t.center), void 0 !== t.decay && (this.decay = D(t.decay)), void 0 !== t.direction && (this.direction = t.direction), void 0 !== t.distance && (this.distance = bt(t.distance) ? {
        horizontal: t.distance,
        vertical: t.distance
      } : {...t.distance}), void 0 !== t.drift && (this.drift = D(t.drift)), void 0 !== t.enable && (this.enable = t.enable), this.gravity.load(t.gravity);
      const e = t.outModes;
      void 0 !== e && (_t(e) ? this.outModes.load(e) : this.outModes.load({default: e})), this.path.load(t.path), void 0 !== t.random && (this.random = t.random), void 0 !== t.size && (this.size = t.size), void 0 !== t.speed && (this.speed = D(t.speed)), this.spin.load(t.spin), void 0 !== t.straight && (this.straight = t.straight), this.trail.load(t.trail), void 0 !== t.vibrate && (this.vibrate = t.vibrate), void 0 !== t.warp && (this.warp = t.warp)
    }
  }
  ...
  class ti {
    constructor() {
      this.blur = 0, this.color = new ce, this.enable = !1, this.offset = {x: 0, y: 0}, this.color.value = "#000"
    }
  ...
  class li {
    ...
    setTheme(t) {
      if (t) {
        ...
        const t = N("(prefers-color-scheme: dark)"), e = t && t.matches,
  ...
  class ui {
    constructor(t, e, i, s, o, n) {
      this.container = i, this._calcPosition = (t, e, i, s = 0) => {
        ...
        const o = B({size: t.canvas.size, position: e}), n = m.create(o.x, o.y, i), a = this.getRadius(),
          r = this.options.move.outModes, c = e => {
            di({
              outMode: e,
        ...
        const i = Math.PI / 180 * P(e.angle.value), s = Math.PI / 180 * P(e.angle.offset),
          o = {left: s - .5 * i, right: s + .5 * i};
    ...
    init(t, e, i, s) {
      ...
      this.id = t, this.group = s, this.effectClose = !0, this.effectFill = !0, this.shapeClose = !0, this.shapeFill = !0, this.pathRotation = !1, this.lastPathTime = 0, this.destroyed = !1, this.unbreakable = !1, this.rotation = 0, this.misplaced = !1, this.retina = {maxDistance: {}}, this.outType = "normal", this.ignoresResizeRatio = !0;
      const a = o.retina.pixelRatio, r = o.actualOptions, c = ci(this._engine, o, r.particles), l = c.effect.type,
        h = c.shape.type, {reduceDuplicates: d} = c;
      ...
      this.pathDelay = 1e3 * P(y.delay.value), y.generator && (this.pathGenerator = this._engine.getPathGenerator(y.generator), this.pathGenerator && o.addPath(y.generator, this.pathGenerator) && this.pathGenerator.init(o)), o.retina.initParticle(this), this.size = ft(this.options.size, a), this.bubble = {inRange: !1}, this.slow = {
        inRange: !1,
        factor: 1
  ...
  class mi extends fi {
    ...
    intersects(t) {
      ...
      const e = this.size.width, i = this.size.height, s = this.position, o = t.position,
        n = t instanceof mi ? t.size : {width: 0, height: 0}, a = n.width, r = n.height;
  ...
  class wi {
    constructor(t, e) {
      this._addToPool = (...t) => {
        ...
        const o = this._initDensityFactor(s.density), n = s.value, a = s.limit.value > 0 ? s.limit.value : n,
          r = Math.min(n, a) * o + e, c = Math.min(this.count, this.filter((t => t.group === i)).length);
    ...
    addParticle(t, e, i, s) {
      const o = this._container.actualOptions.particles.number.limit,
        n = void 0 === i ? this._limit : this._groupLimits.get(i) ?? this._limit, a = this.count;
      if (n > 0) if ("delete" === o.mode) {
        const t = a + 1 - n;
  ...
  class zi {
    constructor(t, e, i) {
      ...
      }, this.plugins = new Map, this.effectDrawers = new Map, this.shapeDrawers = new Map, this._options = _i(this._engine, this), this.actualOptions = _i(this._engine, this), this._eventListeners = new re(this), this._intersectionObserver = X((t => this._intersectionManager(t))), this._engine.dispatchEvent("containerBuilt", {container: this})
    }
    ...
    addClickHandler(t) {
      ...
      const i = (e, i, s) => {
        if (!xi(this)) return;
        const o = this.retina.pixelRatio, n = {x: i.x * o, y: i.y * o},
      ...
      e.addEventListener("click", (t => {
        if (!xi(this)) return;
        const e = t, s = {x: e.offsetX || e.clientX, y: e.offsetY || e.clientY};
        i(t, s, 1)
        ...
        if (xi(this)) {
          if (s && !o) {
            ...
            const o = this.canvas.element, n = o ? o.getBoundingClientRect() : void 0,
  ...
  class Pi {
    ...
    async load(t) {
      const e = t.id ?? t.element?.id ?? `tsparticles${Math.floor(1e4 * _())}`, {index: s, url: o} = t,
        ...
        }({fallback: t.options, url: o, index: s}) : t.options;
      ...
      let h;
      if ("canvas" === a.tagName.toLowerCase()) h = a, h.dataset[i] = "false"; else {
  ...
  class Si {
    ...
    handleRangeColor(t) {
      const e = t.value.hsl ?? t.value;
      if (void 0 !== e.h && void 0 !== e.l) return Lt({h: P(e.h), l: P(e.l), s: P(e.s)})
    }
  ...
  class Ri {
    constructor() {
      this._initSpin = t => {
        ...
        const s = i.position ?? {x: 50, y: 50},
          o = {x: .01 * s.x * e.canvas.size.width, y: .01 * s.y * e.canvas.size.height}, n = T(t.getPosition(), o),
          a = P(i.acceleration);
    ...
    init(t) {
      ...
      t.gravity = {enable: e.enable, acceleration: P(e.acceleration), inverse: e.inverse}, this._initSpin(t)
    }
    ...
    move(t, e) {
      ...
      const o = t.container, n = o.retina.pixelRatio, a = function (t) {
        ...
        }(t), r = (t.retina.moveSpeed ??= P(s.speed) * n) * o.retina.reduceFactor,
        c = t.retina.moveDrift ??= P(t.options.move.drift) * n, l = k(i.size.value) * n,
        h = r * (s.size ? t.getRadius() / l : 1) * a * (e.factor || 1) / 2, d = t.retina.maxSpeed ?? o.retina.maxSpeed;
      s.spin.enable ? function (t, e) {
        ...
        const e = t.initialPosition, {dx: i, dy: s} = O(e, t.position), o = Math.abs(i),
          n = Math.abs(s), {maxDistance: a} = t.retina, r = a.horizontal, c = a.vertical;
        if (r || c) if ((r && o >= r || c && n >= c) && !t.misplaced) t.misplaced = !!r && o > r || !!c && n > c, r && (t.velocity.x = .5 * t.velocity.y - t.velocity.x), c && (t.velocity.y = .5 * t.velocity.x - t.velocity.y); else if ((!r || o < r) && (!c || n < c) && t.misplaced) t.misplaced = !1; else if (t.misplaced) {
  ...
  class Fi {
    ...
    particleInit(t, e) {
      const i = e.shapeData, s = i?.angle ?? {max: 360, min: 0};
      e.circleRange = _t(s) ? {min: s.min * Math.PI / 180, max: s.max * Math.PI / 180} : {
        min: 0,
        max: s * Math.PI / 180
      }
    }
  ...
  class Vi {
    ...
    update(t, e, i, s) {
      ...
      }({particle: t, outMode: s, direction: e, bounds: l, canvasSize: h, offset: r, size: c}), function (t) {
      ...
      }({particle: t, outMode: s, direction: e, bounds: l, canvasSize: h, offset: r, size: c})
    }
  }
    ...
    update(t, e, i, s) {
      ...
      switch (t.outType) {
        case"inside": {
          ...
          t.position.x = Math.floor(C({min: 0, max: o.canvas.size.width})), t.position.y = Math.floor(C({
            min: 0,
  ...
  const Ni = .5, Xi = {
    heart: {
      segments: [{values: [{x: 0, y: Ni}, {x: 0, y: Ni}, {x: Ni, y: 0}, {x: Ni, y: -Ni / 2}]}, {
        values: [{
          x: Ni,
          y: -Ni / 2
        }, {x: Ni, y: -Ni / 2}, {x: Ni, y: -Ni}, {x: Ni / 2, y: -Ni}]
      }, {values: [{x: Ni / 2, y: -Ni}, {x: Ni / 2, y: -Ni}, {x: 0, y: -Ni}, {x: 0, y: -Ni / 2}]}]
    },
    diamond: {
      segments: [{values: [{x: 0, y: Ni}, {x: 0, y: Ni}, {x: .375, y: 0}, {x: .375, y: 0}]}, {
        values: [{
          x: .375,
          y: 0
        }, {x: .375, y: 0}, {x: 0, y: -Ni}, {x: 0, y: -Ni}]
      }]
    },
    club: {
      segments: [{
        values: [{x: 0, y: -Ni}, {x: 0, y: -Ni}, {x: Ni / 2, y: -Ni}, {
          x: Ni / 2,
          y: -Ni / 2
        }]
      }, {
        values: [{x: Ni / 2, y: -Ni / 2}, {x: Ni / 2, y: -Ni / 2}, {x: Ni, y: -Ni / 2}, {
          x: Ni,
          y: 0
        }]
      }, {values: [{x: Ni, y: 0}, {x: Ni, y: 0}, {x: Ni, y: Ni / 2}, {x: Ni / 2, y: Ni / 2}]}, {
        values: [{
          x: Ni / 2,
          y: Ni / 2
        }, {x: Ni / 2, y: Ni / 2}, {x: Ni / 8, y: Ni / 2}, {x: Ni / 8, y: Ni / 8}]
      }, {
        values: [{x: Ni / 8, y: Ni / 8}, {x: Ni / 8, y: Ni / 2}, {x: Ni / 2, y: Ni}, {
          x: Ni / 2,
          y: Ni
        }]
      }, {values: [{x: Ni / 2, y: Ni}, {x: Ni / 2, y: Ni}, {x: 0, y: Ni}, {x: 0, y: Ni}]}]
    },
    spade: {
      segments: [{values: [{x: 0, y: -Ni}, {x: 0, y: -Ni}, {x: Ni, y: -Ni / 2}, {x: Ni, y: 0}]}, {
        values: [{
          x: Ni,
          y: 0
        }, {x: Ni, y: 0}, {x: Ni, y: Ni / 2}, {x: Ni / 2, y: Ni / 2}]
      }, {
        values: [{x: Ni / 2, y: Ni / 2}, {x: Ni / 2, y: Ni / 2}, {x: Ni / 8, y: Ni / 2}, {
          x: Ni / 8,
          y: Ni / 8
        }]
      }, {
  ...
  class as {
    ...
    async update(t) {
      this._paused || (this._firstSpawn && (this._firstSpawn = !1, this._currentSpawnDelay = this._spawnDelay ?? 0, this._currentEmitDelay = this._emitDelay ?? 0), this._startParticlesAdded || (this._startParticlesAdded = !0, await this._emitParticles(this.options.startCount)), void 0 !== this._duration && (this._currentDuration += t.value, this._currentDuration >= this._duration && (this.pause(), void 0 !== this._spawnDelay && delete this._spawnDelay, this._immortal || this._lifeCount--, this._lifeCount > 0 || this._immortal ? (this.position = this._calcPosition(), this._shape?.resize(this.position, this.size), this._spawnDelay = 1e3 * P(this.options.life.delay ?? 0) / this.container.retina.reduceFactor) : this._destroy(), this._currentDuration -= this._duration, delete this._duration)), void 0 !== this._spawnDelay && (this._currentSpawnDelay += t.value, this._currentSpawnDelay >= this._spawnDelay && (this._engine.dispatchEvent("emitterPlay", {container: this.container}), this.play(), this._currentSpawnDelay -= this._currentSpawnDelay, delete this._spawnDelay)), void 0 !== this._emitDelay && (this._currentEmitDelay += t.value, this._currentEmitDelay >= this._emitDelay && (this._emit(), this._currentEmitDelay -= this._emitDelay)))
    }
    ...
    _calcPosition() {
      ...
      return A({size: this.container.canvas.size, position: this.options.position})
    }
    ...
    _calcSize() {
      ...
      if (this.options.domId) {
        ...
        if (e) {
          const i = e.getBoundingClientRect();
          return {width: i.width * t.retina.pixelRatio, height: i.height * t.retina.pixelRatio, mode: "precise"}
        }
      }
      ...
      for (let i = 0; i < t; i++) {
        ...
        if (this._shape) {
          ...
          if (e) {
            s = e.position;
            const o = i.replace;
            o.color && e.color && ns(t, e.color), o.opacity && (t.opacity ? t.opacity.value = e.opacity : t.opacity = {value: e.opacity})
          } else s = null
        }
  ...
  class rs {
    ...
    handleClickMode(t) {
      ...
      if ("emitter" !== t) return;
      let s;
      if (i && zt(i.value)) if (i.value.length > 0 && i.random.enable) {
        s = [];
        const t = [];
    ...
    async init() {
      if (this.emitters = this.container.actualOptions.emitters, this.interactivityEmitters = this.container.actualOptions.interactivity.modes.emitters, this.emitters) if (zt(this.emitters)) for (const t of this.emitters) await this.addEmitter(t); else await this.addEmitter(this.emitters)
    }
  ...
  class hs {
    ...
    loadOptions(t, e) {
      ...
      if (i) if (zt(i)) t.interactivity.modes.emitters = {
        random: {count: 1, enable: !0}, value: i.map((t => {
          const e = new os;
          return e.load(t), e
        }))
      }; else {
        const e = i;
        if (void 0 !== e.value) if (zt(e.value)) t.interactivity.modes.emitters = {
          random: {
          ...
          (t.interactivity.modes.emitters = {random: {count: 1, enable: !1}, value: new os}).value.load(i)
        }
      }
    }
  ...
  class ps {
    ...
    async init(t) {
      ...
      if (ds.find((t => Z(t, e.particles.shape.type)))) {
        const t = [Q(us)], i = ds.map((t => e.particles.shape.options[t])).find((t => !!t));
        i && dt(i, (e => {
      ...
      case 44:
        await async function (t, e, i, s, o, n) {
          ...
          const d = t => {
            ...
            return {r: s, g: n, b: r, a: t === o(null) ? i ? ~~((s + n + r) / 3) : 0 : 255}
          }, u = (() => {
            try {
          ...
          if (l) {
            for (let i = 0, o = p + 1, r = 0, c = [[0]], l = 0; l < 4; l++) {
              ...
              n?.(t.pos / (t.data.length - 1), s(!1) + 1, u, {x: a.left, y: a.top}, {width: e.width, height: e.height})
            }
      ...
      case 33:
        await async function (t, e, i, s) {
          switch (t.nextByte()) {
            ...
            case 255: {
              t.pos++;
              const i = {identifier: t.getString(8), authenticationCode: t.getString(3), data: t.readSubBlocksBin()};
  ...
  function Ms(t, e, i, s) {
    ...
    return new Promise((e => {
      const i = new Blob([o], {type: "image/svg+xml"}), s = URL || window.URL || window.webkitURL || window,
        a = s.createObjectURL(i), r = new Image;
  ...
  class Cs {
    ...
    draw(t) {
      ...
      if (a) {
        if (e.globalAlpha = o, a.gif && a.gifData) {
          ...
          let r = s.gifFrame ?? 0;
          const c = {x: .5 * -a.gifData.width, y: .5 * -a.gifData.height}, l = a.gifData.frames[r];
          ...
          const t = a.ratio, s = {x: -i, y: -i}, o = 2 * i;
    ...
    particleInit(t, e) {
      ...
      n.loading ? setTimeout((() => {
        ...
        const i = {image: t, fill: s.fill ?? e.shapeFill, close: s.close ?? e.shapeClose};
  ...
  class As {
    draw(t) {
      const {context: e, particle: i, radius: s} = t, o = this.getCenter(i, s), n = this.getSidesData(i, s),
        a = n.count.numerator * n.count.denominator, r = n.count.numerator / n.count.denominator, c = 180 * (r - 2) / r,
  ...
  class Gs {
    ...
    init(t) {
      !function (t) {
        ...
        if (e?.enable) if (t.roll = {
          enable: e.enable,
          horizontal: "horizontal" === e.mode || "both" === e.mode,
          vertical: "vertical" === e.mode || "both" === e.mode,
          angle: _() * Math.PI * 2,
          speed: P(e.speed) / 360
        }, e.backColor) t.backColor = It(e.backColor); else if (e.darken.enable && e.enlighten.enable) {
          const i = _() >= .5 ? "darken" : "enlighten";
          t.roll.alter = {type: i, value: P("darken" === i ? e.darken.value : e.enlighten.value)}
  ...
  class Ws {
    ...
    init(t) {
      ...
      if (!e) return;
      t.rotate = {enable: e.animation.enable, value: P(e.value) * Math.PI / 180}, t.pathRotation = e.path;
      let i = e.direction;
      if ("random" === i) {
  ...
  class Js {
    ...
    update(t, e) {
      this.isEnabled(t) && function (t, e) {
        ...
        const i = t.options.tilt.animation, s = (t.tilt.velocity ?? 0) * e.factor, o = 2 * Math.PI,
          n = t.tilt.decay ?? 1;
  ...
  class to {
    ...
    load(t) {
      if (t && (void 0 !== t.distance && (this.distance = D(t.distance)), void 0 !== t.enable && (this.enable = t.enable), void 0 !== t.speed)) if (bt(t.speed)) this.speed.load({angle: t.speed}); else {
        const e = t.speed;
  ...
  async function ao(t) {
    ...
    if (oo.has(t.id) && (i = oo.get(t.id), i && !i.destroyed)) {
      ...
      if (t.addEmitter) return void t.addEmitter({
        ...
        particles: {
          ...
          opacity: {
            value: {min: 0, max: 1},
            animation: {enable: !0, sync: !0, speed: s, startValue: "max", destroy: "min"}
          },
    ...
    const o = {
      ...
      particles: {
        ...
        rotate: {enable: false, value: 90, direction: "clockwise", path: false,
    ...
    return i = await Ti.load({id: t.id, element: t.canvas, options: o}), oo.set(t.id, i), i
  }

  async function ro(t, e) {
    let i, s;
    return await no(Ti), wt(t) ? (s = t, i = e ?? {}) : (s = "confetti", i = t), ao({id: s, options: i})
  }
  ...
  return ro.create = async (t, e) => {
    ...
    return t.setAttribute("id", i), async (s, o) => {
      let n, a;
      return wt(s) ? (a = s, n = o ?? e) : (a = i, n = s), ao({id: a, canvas: t, options: n})
    }
